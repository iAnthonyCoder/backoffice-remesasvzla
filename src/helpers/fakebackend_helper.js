...
// get Products
// export const getProducts = (query) => get(url.GET_PRODUCTS+(query ? query : ''))
...
// get contacts
export const getUsers = ({query}) => get(url.GET_USERS+query)
...
export const getCurrencyProfile = () => get(url.CURRENCIES)
...
export const deleteCurrency = currency =>
  del(url.CURRENCIES+'/'+currency._id)
